"""HMAC auth middleware for the video worker.
...
logger = logging.getLogger("video-worker.access")
...
class HMACAuthMiddleware:
    """Verify `X-Video-*` HMAC headers before the request reaches the routes."""
